...
(function() {
  ...
  // CSSのキャッシュ破り用動的インジェクション (v90に対応 & 重複ロード防止)
  (function injectLatestCSS() {
    if (document.querySelector('link[href*="custom-editor-v90.css"]')) return;
    const link = document.createElement('link');
    link.rel = 'stylesheet';
    link.href = './assets/custom-editor-v90.css?v=' + Date.now();
    document.head.appendChild(link);
    console.log('[Custom Flowmap] Injected latest stylesheet (v90):', link.href);
  })();
