  ...
  // --- ログインセッション自動修復フォールバックロジックを安全性のために排除 ---
    ...
    if (logoArea && logoTextSpan && logoImg) {
      if (isPro && g.logoPosition === "top") {
        ...
        if (g.logoType === "image") {
          ...
          logoTextSpan.style.display = g.header.logoText ? 'block' : 'none';
    ...
    if (previewFooterLogoContainer && footerLogoImg && footerLogoText) {
      if (isPro && g.logoPosition === "bottom") {
        ...
        if (g.logoType === "image") {
          ...
          footerLogoText.textContent = g.header.logoText || "";
          footerLogoText.style.display = g.header.logoText ? 'block' : 'none';
    ...
    if (liveLogoArea && liveLogoTextSpan && liveLogoImg) {
      if (isPro && g.logoPosition === "top") {
        ...
        if (g.logoType === "image") {
          ...
          liveLogoTextSpan.style.display = g.header.logoText ? 'block' : 'none';
    ...
    if (liveFooterLogoContainer && liveFooterLogoImg && liveFooterLogoText) {
      if (isPro && g.logoPosition === "bottom") {
        ...
        if (g.logoType === "image") {
          ...
          liveFooterLogoText.textContent = g.header.logoText || "";
          liveFooterLogoText.style.display = g.header.logoText ? 'block' : 'none';
