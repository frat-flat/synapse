...
(function() {
  ...
  (function setupLocalStorageHook() {
    ...
    localStorage.getItem = function(key) {
      if (key === 'form_customize_all_forms') {
        ...
        if (isTemplateMode && isReactEditorActive) {
  ...
  // 誤ってテンプレートマスタ側に作成されてしまった日付入りフォームデータを、作成中フォーム一覧へ救出・移行するマイグレーション処理
