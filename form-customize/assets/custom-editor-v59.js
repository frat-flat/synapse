  ...
  function syncActiveTabAndDropdown() {
    ...
    if (badge) {
      if (tabName !== 'dashboard') {
        ...
        if (!select || (window.G && select.value !== `form_${localStorage.getItem('form_customize_active_index')}` && select.value !== `template_${localStorage.getItem('form_customize_active_index')}`)) {
