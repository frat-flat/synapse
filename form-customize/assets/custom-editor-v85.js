...
(function() {
  ...
  // CSSのキャッシュ破り用動的インジェクション (v81に対応 & 重複ロード防止)
  (function injectLatestCSS() {
    if (document.querySelector('link[href*="custom-editor-v85.css"]')) return;
    const link = document.createElement('link');
    link.rel = 'stylesheet';
    link.href = './assets/custom-editor-v85.css?v=' + Date.now();
    ...
    if (isPartial) {
      ...
      infoArea.innerHTML = `
        ...
        <div style="background: rgba(237, 242, 247, 0.6); border: 1px solid #cbd5e0; border-radius: 8px; padding: 14px;">
          <div style="font-size: 0.8rem; font-weight: 700; color: #4a5568; margin-bottom: 4px;">🔗 続きから回答する専用リンク</div>
