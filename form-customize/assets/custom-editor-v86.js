...
(function() {
  ...
  // CSSのキャッシュ破り用動的インジェクション (v86に対応 & 重複ロード防止)
  (function injectLatestCSS() {
    if (document.querySelector('link[href*="custom-editor-v86.css"]')) return;
    const link = document.createElement('link');
    link.rel = 'stylesheet';
    link.href = './assets/custom-editor-v86.css?v=' + Date.now();
