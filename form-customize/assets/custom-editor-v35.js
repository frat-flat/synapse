...
(function() {
  ...
  function applyPreviewTheme() {
    ...
    if (isPro && g.useBgImage && g.bgTheme) {
      ...
      previewContainer.style.setProperty('background', 'none', 'important');
    } else {
  ...
  function renderLivePreview() {
    ...
    if (liveCard) {
      ...
      if (isPro && g.useBgImage && g.bgTheme) {
        ...
        liveCard.style.setProperty('background', 'none', 'important');
      } else {
        liveCard.style.removeProperty('background');
      }
